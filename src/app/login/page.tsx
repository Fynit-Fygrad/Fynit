      ...
      <div className="bg-white w-full max-w-md rounded-2xl shadow-xl border border-gray-100 p-8 sm:p-10 transition-all">
        ...
        <form action={action} className="space-y-5">
          ...
          <button
            type="submit"
            disabled={pending}
            className="w-full bg-brand-600 hover:bg-brand-700 disabled:opacity-60 disabled:cursor-not-allowed text-white font-semibold py-3 px-4 rounded-xl shadow-sm shadow-brand-500/30 transition-all hover:shadow-md hover:-translate-y-0.5 mt-2"
          >
        ...
        <p className="text-center text-sm text-gray-500 mt-8">
          ¿No tienes cuenta?{' '}
          <Link href="/registro" className="font-semibold text-brand-600 hover:text-brand-700 transition-colors">
            Regístrate aquí
          </Link>
        </p>
