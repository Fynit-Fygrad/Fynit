        ...
        <div className="max-w-[1200px] w-full flex flex-col gap-6 pb-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-6 items-start">
              ...
              <div className="bg-white dark:bg-slate-900 rounded-[24px] p-6 border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                ...
                <div className="flex flex-col items-end min-w-[200px] w-full md:w-auto">
                  ...
                  <div className="flex items-center gap-2 mb-2 w-full justify-end">
                    ...
                    <span className="text-[14px] text-slate-400 dark:text-slate-500 font-medium">Fit simulado</span>
                  </div>
            ...
            <div className="flex flex-col gap-4 sticky top-8">
              ...
              <button onClick={() => { update(p => ({ ...p, journal: journal.name, prepared: false }), `Revista seleccionada: ${journal.name}`, "Envío"); router.push("/dashboard/envio"); }} className="w-full flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl bg-white border border-[#2563eb] text-[#2563eb] font-bold text-[14px] shadow-sm hover:bg-blue-50 transition-colors dark:bg-[#0B1120] dark:hover:bg-blue-900/20">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"></path>
                </svg>
                Seleccionar para mi envío
              </button>
